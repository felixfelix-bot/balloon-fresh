...
// Write SET_FLRC_MOD_PARAMS (0x0248) for the given bitrate.
// brBw encoding matches LR2021 datasheet / RadioLib FLRC_BR_* constants.
static void rfSetBitrate(uint16_t kbps) {
    ...
    // MOD_PARAMS: brBw | coding rate + BT (CR_1_0=0x02<<4 | BT_0_5=0x05 = 0x25)
