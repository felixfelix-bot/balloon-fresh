...
static const Phase phases[] = {
    ...
    {"HF-LoRa-SF12",  PT_LORA, 2440.0, 1, 12, 0x0F, 1,    0,  15, 30000},  // V3: halved for 255B
    ...
    {"LF-LoRa-SF9",   PT_LORA,  868.0, 0,  9, 0x05, 1,    0,  30, 20000},  // V3: reduced for 255B
    {"LF-LoRa-SF12",  PT_LORA,  868.0, 0, 12, 0x05, 1,    0,  10, 50000},  // V3: halved for 255B
...
void loop() {
    ...
    // V3: fill bytes 31-254 with known pattern for BER analysis
