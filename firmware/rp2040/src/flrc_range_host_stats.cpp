/**
 * @file    flrc_range_host_stats.cpp
 * @brief   Portable integer statistics math (PER, Wilson 95% CI, kbps).
 *
 * Verbatim C++ port of E80 bench_stats.c.  Pure TU — no Arduino includes,
 * compilable by host g++ for unit testing.
 *
 * Port provenance: ~/repos/balloon-e80bench/firmware/e80-stm32-bench/src/bench_stats.c
 */
