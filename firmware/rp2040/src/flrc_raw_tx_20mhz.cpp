/*
 * flrc_raw_tx_20mhz.cpp — RP2040 FLRC TX with RAW SPI init (no RadioLib)
 * v4-20MHz: Pure Arduino SPI + CDC-safe init + BUSY-based TX completion
 *
 ...
 *
 * 20MHz test variant — SPI clock bumped from 16MHz to 20MHz.
 *
...
#define SPI_FREQ_HZ     20000000UL  // 20MHz test
...
void setup() {
    ...
    Serial1.println();
    Serial1.println("=== RP2040 FLRC RAW TX v4-20MHz ===");
